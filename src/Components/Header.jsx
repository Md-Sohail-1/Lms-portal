    ...
    <>
      <div className="px-3 fixed z-20 w-screen top-0 h-16 bg-violet-600 flex items-center justify-between" >
        ...
        <div className="flex gap-2" >
          ...
          <button onClick={()=> setDisplayAlert(true)} className="group border-2 border-slate-100 rounded-md flex items-center justify-center gap-2 md:min-h-5 md:min-w-5 p-2 hover:py-1 md:px-4 md:py-1 text-white ease-in-out transition duration-200" >
